...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Nutrition RAG Assistant",
    page_icon="📖",
    layout="wide"
)
...
with st.sidebar:
    ...
    st.markdown("""
    ### About
    This RAG assistant answers questions about nutrition using a curated collection of sources, including text files, PDFs, and YouTube video transcripts:
    - Storing all nutrition content in a vector database built from text files, PDFs, and YouTube transcripts  
    - Using semantic search with embeddings to find the most relevant passages for each question  
    - Letting a custom nutrition agent decide when to call the database and then synthesize an answer from the retrieved evidence  
    """)
...
st.markdown("Ask questions about Nutrition and get AI-powered answers based on curated content.")
...
if prompt := st.chat_input("Ask a question about Nutrition..."):
...
with st.expander("💡 Example Questions"):
    examples = [
        ...
        "How can I build a balanced meal plate? 🥗",
        "Which foods help improve gut health? 🦠",
        "What are the signs of vitamin deficiencies? 💊","How does hydration impact overall health? 💧"
